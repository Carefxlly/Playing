 ...
 */
public class XRefreshX extends LinearLayout implements XBaseRefresh {
    ...
    public XRefreshX(Context context) {
        this(context, null);
    }

    public XRefreshX(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRefreshX(Context context, AttributeSet attrs, int defStyleAttr) {
