...
import com.example.jingbin.cloudreader.dataclass.moviechild.SubjectsBean;
...
import com.example.jingbin.cloudreader.tools.StringFormatUtil;
import com.example.jingbin.cloudreader.widgets.CallBack_ScrollChanged;
import com.example.jingbin.cloudreader.widgets.DiscoverScrollView;
import com.example.jingbin.cloudreader.widgets.test.RCVListAdapter;
import com.example.jingbin.cloudreader.widgets.test.StatusBarUtils;

import java.util.Arrays;

import static com.example.jingbin.cloudreader.widgets.statusbar.StatusBarUtil.getStatusBarHeight;
...
public class SlideScrollViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            subjectsBean = (SubjectsBean) getIntent().getSerializableExtra("dataclass");
        }
        // 先设置状态栏透明
...
//            actionBar.setSubtitle("主演：" + StringFormatUtil.formatName(subjectsBean.getCasts()));
    ...
    public static void start(Activity context, SubjectsBean positionData, ImageView imageView) {
        ...
        intent.putExtra("dataclass", positionData);
