package com.example.jingbin.cloudreader.widgets.webview.config;
...
import com.example.jingbin.cloudreader.tools.CheckNetwork;
...
//        DebugUtil.error("----url:"+url);
        ...
        if (url.startsWith("network:") || url.startsWith("https:")) {
            // 可能有提示下载Apk文件
            if (url.contains(".apk")) {
