...
import com.example.jingbin.cloudreader.dataclass.AndroidBean;
import com.example.jingbin.cloudreader.dataclass.FrontpageBean;
import com.example.jingbin.cloudreader.repository.model.EverydayModel;
import com.example.jingbin.cloudreader.network.RequestImpl;
import com.example.jingbin.cloudreader.network.cache.ACache;
...
public class EverydayViewModel extends ViewModel {
    ...
    public void handleCache() {
        ...
        try {
            ...
            result = (ArrayList<FrontpageBean.ResultBannerBean.FocusBean.ResultBeanX>) maCache
                    .getAsObject(Constants.BANNER_PIC_DATA);
        } catch (Exception e) {
            e.printStackTrace();
        }
