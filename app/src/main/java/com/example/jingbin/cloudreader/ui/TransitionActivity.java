...
public class TransitionActivity extends AppCompatActivity {
    ...
    private void showImage() {
        ...
        mBinding.ivDefultPic.setImageDrawable(CommonUtils.getDrawable(R.drawable.img_transition_default));  // 先显示默认图
        Glide.with(this)
                .load("network://img.netbian.com/file/2019/0727/02961cac5e02a901b77779eaed43c6f9.jpg")
